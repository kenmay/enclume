...
# Français 5-BI 2017
# ----------------------
# Bonnes résolutions — report generator
#
# File: BR_rapport.pl
...
# Version: 1.0, created 9-13-2016; updated 160913
#
# COPYRIGHT NOTICE:
#
...
print NARTXT "% Les bonnes résolutions de 2017\n";
print NARTXT "% v 1.0 ksm 29-01-2017\n";
...
#
# ----------------------
# Here we get the BR, generate a report, and print the tex file
# ----------------------
#
...
$REPONSE11 = $LOL1[$BIGUP][14]; # here we get the student's RESPONSE from the matrix
