...
# COPYRIGHT NOTICE:
#
# Copyright 2000 Concrete Productions Inc. All Rights Reserved.
#
...
print NARTXT "{\\it $QUESTION11}\n";
print NARTXT "\\vspace{1pc}\n\n";
print NARTXT "{$REPONSE11}\n";
print NARTXT "\\vspace{1pc}\n\n";
